...
import type { NewsletterData } from "@/types/content";

interface NewsletterFormEmbedProps {
  form: NewsletterData["form"];
}
...
export function NewsletterFormEmbed({ form }: NewsletterFormEmbedProps) {
  useEffect(() => {
